...
export const NEW_FILE_LABEL = nls.localize2('newFile', "Novo Arquivo...");
export const NEW_FOLDER_COMMAND_ID = 'explorer.newFolder';
export const NEW_FOLDER_LABEL = nls.localize2('newFolder', "Nova Pasta...");
export const TRIGGER_RENAME_LABEL = nls.localize('rename', "Renomear...");
export const MOVE_FILE_TO_TRASH_LABEL = nls.localize('delete', "Deletar");
export const COPY_FILE_LABEL = nls.localize('copyFile', "Copiar");
export const PASTE_FILE_LABEL = nls.localize('pasteFile', "Colar");
